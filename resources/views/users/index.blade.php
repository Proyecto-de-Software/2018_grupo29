	    ...
	    <div class="row">
	    	<ul class="list-group" style="width: 100%">
		    	<li class="list-group-item row d-flex text-center">
		    		<div class="col-sm-2 text-info">Nombre y apellido</div>
		    		<div class="col-sm-2 text-info">Nombre de usuario</div>
		    		<div class="col-sm-2 text-info">Email</div>
		    		<div class="col-sm-1 text-info">Estado</div>
		    		<div class="col-sm-2 text-info"></div>
		    		<div class="col-sm-1 text-info"></div>
		    		<div class="col-sm-1 text-info"></div>
		    		<div class="col-sm-1 text-info"></div>
		    	</li>
			    @foreach ($users as $user)
			    <li class="list-group-item row d-flex text-center">
			    	<div class="col-sm-2"> {{ $user->first_name }} {{ $user->last_name }}</div>
