        ...
        t(z.prototype, {
            sanitizeSVG: function(a, b) {
                if (b && b.exporting && b.exporting.allowHTML) {
                    var e = a.match(/<\/svg>(.*?$)/);
                    e && e[1] && (e = '\x3cforeignObject x\x3d"0" y\x3d"0" width\x3d"' + b.chart.width + '" height\x3d"' + b.chart.height + '"\x3e\x3cbody xmlns\x3d"http://www.w3.org/1999/xhtml"\x3e' +
            ...
            getSVG: function(a) {
                ...
                c = h.exporting.sourceWidth || h.chart.width || /px$/.test(c) && parseInt(c, 10) ||
                    600;
            ...
            contextMenu: function(a, b, e, c, v, m, h) {
                var d = this,
                    ...
                    w = Math.max(v, m),
                    x;
                k || (d.exportContextMenu = d[p] = k = r("div", {
                    className: a
                }, {
                    position: "absolute",
                    zIndex: 1E3,
                ...
                }, n.menuStyle)), k.hideMenu = function() {
                    u(k, {
                        display: "none"
                    });
                    h && h.setState(0);
                ...
                }, d.exportEvents.push(q(k, "mouseleave", function() {
                    k.hideTimer =
                ...
                }), d.exportDivElements.push(x, k), d.exportMenuWidth = k.offsetWidth, d.exportMenuHeight = k.offsetHeight);
                b = {
                    display: "block"
                };
                e + d.exportMenuWidth > g ? b.right = g - e - v - w + "px" : b.left = e - w + "px";
                c + m + d.exportMenuHeight > G && "top" !== h.alignOptions.verticalAlign ? b.bottom = G - c - w + "px" : b.top = c + m - w + "px";
                u(k, b);
                d.openMenu = !0
            },
            addButton: function(a) {
                ...
                if (!1 !== c.enabled) {
                    ...
                    c.text && c.symbol ? g.paddingLeft = A(g.paddingLeft, 25) : c.text || t(g, {
                        width: c.width,
                        height: c.height,
                        padding: 0
                    });
                    d = e.button(c.text, 0, 0, k, g, q, l).addClass(a.className).attr({
            ...
            destroyExport: function(a) {
                ...
                var e = b.exportDivElements,
                    ...
                    g;
                a && (l(a, function(a, c) {
                    a && (a.onclick = a.ontouchstart = null, g = "cache-" + a.menuClassName, b[g] && delete b[g], b.exportSVGElements[c] = a.destroy())
                }), a.length = 0);
                b.exportingGroup &&
